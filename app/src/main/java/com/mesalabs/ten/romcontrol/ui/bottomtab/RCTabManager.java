package com.mesalabs.ten.romcontrol.ui.bottomtab;
...
public class RCTabManager {
    private static final String KEY = "ten_current_bottom_tab";

    private SharedPreferencesUtils sp;
    private int mSelectedTab = 0;
    private int mPreviousTab = mSelectedTab;

    public RCTabManager(String spName) {
